...
{	
	...
	{	
        ...
        public CheckPoint PlayerSpawnPoint
		{
			get
			{
		...
		protected override void Awake()
		{
			...
			_initialSpawnPointPosition = (PlayerSpawnPoint == null) ? Vector3.zero : PlayerSpawnPoint.transform.position;
		}
		...
		protected virtual void SpawnSingleCharacter()
		{
			...
			{
                PlayerSpawnPoint.SpawnPlayer(Players[0]);
				TopDownEngineEvent.Trigger(TopDownEngineEventTypes.SpawnComplete, Players[0]);
				return;
			}
