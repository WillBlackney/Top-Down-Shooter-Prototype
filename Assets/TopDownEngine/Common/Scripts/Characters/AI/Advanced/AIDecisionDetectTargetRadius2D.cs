...
namespace MoreMountains.TopDownEngine
{
	...
	public class AIDecisionDetectTargetRadius2D : AIDecision
	{
		...
		{
			//Debug.LogWarning("AIDecisionDetectTargetRadius2D.DetectTarget, " + gameObject.name);
            ...
            Debug.LogWarning("AIDecisionDetectTargetRadius2D.DetectTarget, " + gameObject.name + ", possible targets :::");
			foreach(Transform t in _potentialTargets)
			{
				Debug.LogWarning(t.gameObject.name);
			}
